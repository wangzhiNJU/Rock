...
QP::QP(RockContext* ir, Device* id, SRQ* is, CQ* ic, ibv_qp_type qp_type) : rct(ir), device(id), srq(is), cq(ic) {
  ...
  local_syn.local_psn = lran48() & 0xffffff;
